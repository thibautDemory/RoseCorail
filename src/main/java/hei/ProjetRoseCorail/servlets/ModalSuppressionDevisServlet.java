...
@WebServlet("/administration/ModalSuppressionDevis")
public class ModalSuppressionDevisServlet extends GenericServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        templateEngine.process("ModalSuppressionDevis", webContext, resp.getWriter());
    }
}
