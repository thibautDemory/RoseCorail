...
@MultipartConfig
@WebServlet("/administration/ModifierPhotosDePresentation")
public class ModifierPhotosDePresentationServlet extends GenericServlet{
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        templateEngine.process("/administration/ModifierPhotosDePresentation", webContext, resp.getWriter());
    }
