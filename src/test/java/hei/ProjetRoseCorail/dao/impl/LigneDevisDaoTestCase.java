...
public class LigneDevisDaoTestCase {
    ...
    public void initDb() throws Exception {
        try (Connection connection = DataSourceProvider.getDataSource().getConnection();
            ...
            stmt.executeUpdate("INSERT INTO `lignedevis`(id_ligne_devis,id_couleur,id_devis,id_article) VALUES (1,1,1,3)");
            stmt.executeUpdate("INSERT INTO `lignedevis`(id_ligne_devis,id_couleur,id_devis,id_article) VALUES (2,1,2,3)");
            stmt.executeUpdate("INSERT INTO `lignedevis`(id_ligne_devis,id_couleur,id_devis,id_article) VALUES (3,2,2,3)");
        }
    }
    @Test
    public void shouldaddLigneDevis()throws Exception{
        //given
        LigneDevis ligneDevis = new LigneDevis(null,1,2,3);
        //WHEN
        ...
        try (Connection connection=DataSourceProvider.getDataSource().getConnection();
             Statement stmt=connection.createStatement()){
            try(ResultSet rs=stmt.executeQuery("SELECT lignedevis.id_ligne_devis, lignedevis.id_couleur, lignedevis.id_devis, lignedevis.id_article " +
    ...
    public void shouldlistLignesDevisPourUneCouleur(){
        ...
        assertThat(leslignesdevispourunecouleur).extracting("id_ligne_devis","id_couleur","id_devis","id_article").containsOnly(
                tuple(3,2,2,3)
        );
    }
    ...
    public void shouldDeleteLigneDevisPourUneCouleur(){
        ...
        assertThat(leslignesdevis).extracting("id_ligne_devis","id_couleur","id_devis","id_article").containsOnly(
                tuple(1,1,1,3),
                tuple(2,1,2,3)
        );
